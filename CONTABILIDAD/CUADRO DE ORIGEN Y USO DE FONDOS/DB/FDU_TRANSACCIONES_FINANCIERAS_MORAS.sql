-- create tables
create table SAF.FDU_TRANSACCIONES_FINANCIERAS_MORAS (
    id                             number generated by default on null as identity 
                                   constraint PK_FDU_TRANSACCIONES_FINANCIERAS_MORAS primary key,
    id_fdu_transacciones_financieras number(10,0)
                                   constraint FK_FDU_TRANSACCIONES_FINANCIERAS_MORAS
...
-- table index
create index FK_FDU_TRANSACCIONES_FINANCIERAS_MORAS on SAF.FDU_TRANSACCIONES_FINANCIERAS_MORAS (id_fdu_transacciones_financieras);

-- load data
 
-- Generated by Quick SQL Friday September 01, 2023  09:50:28
 
/*
FDU_TRANSACCIONES_FINANCIERAS_MORAS {
    id /pk,
