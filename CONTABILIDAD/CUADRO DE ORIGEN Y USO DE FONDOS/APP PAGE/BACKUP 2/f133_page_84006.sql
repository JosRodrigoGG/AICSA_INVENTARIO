...
,p_last_upd_yyyymmddhh24miss=>'20231031095616'
);
...
,p_display_as=>'NATIVE_POPUP_LOV'
,p_lov=>'STATIC:EMPRESA;EMPRESA,CLIENTE;CLIENTE'
,p_lov_display_null=>'YES'
,p_cSize=>30
,p_colspan=>6
,p_field_template=>wwv_flow_imp.id(99637075642244038)
...
'    (',
'        CASE',
'            WHEN ESTADO = ''ACEPTADO'' THEN ''DEPOSITADO''',
'            WHEN ESTADO = ''LIBERACION'' THEN ''AUTORIZADO''',
'            ELSE ESTADO',
'        END ',
'    ),',
'    CODIGO_MONEDA,',
...
'        REPLACE(:P84006_MONTO_ORIGEN, '','', ''''),',
'        SAF.APX_FNC_CONVERSION_MONEDAS(REPLACE(:P84006_MONTO_ORIGEN, '','', ''''), :P84006_CODIGO_MONEDA, 1, NVL(:P84006_TASA_CAMBIO, SAF.FNC_GET_TIPO_CAMBIO(:P84006_CODIGO_MONEDA)), NULL),',
'        :P84006_OBSERVACIONES,',
'        :P84006_ES_PRESTAMO,',
...
'        MONTO_ORIGEN = REPLACE(:P84006_MONTO_ORIGEN, '','', ''''),',
'        MONTO_LOCAL = SAF.APX_FNC_CONVERSION_MONEDAS(REPLACE(:P84006_MONTO_ORIGEN, '','', ''''), :P84006_CODIGO_MONEDA, 1, NVL(:P84006_TASA_CAMBIO, SAF.FNC_GET_TIPO_CAMBIO(:P84006_CODIGO_MONEDA)), NULL),',
...
,p_attribute_01=>'PLSQL_EXPRESSION'
,p_attribute_04=>'ROUND(SAF.APX_FNC_CONVERSION_MONEDAS(REPLACE(:P84006_MONTO_ORIGEN, '','', ''''), :P84006_CODIGO_MONEDA, 1, NVL(:P84006_TASA_CAMBIO, SAF.FNC_GET_TIPO_CAMBIO(:P84006_CODIGO_MONEDA)), NULL), 2)'
...
,p_attribute_01=>'PLSQL_EXPRESSION'
,p_attribute_04=>'ROUND(SAF.APX_FNC_CONVERSION_MONEDAS(REPLACE(:P84006_MONTO_MORA_ORIGEN, '','', ''''), :P84006_CODIGO_MONEDA, 1, NVL(:P84006_TASA_CAMBIO, SAF.FNC_GET_TIPO_CAMBIO(:P84006_CODIGO_MONEDA)), NULL), 2)'
...
,p_affected_elements=>'P84006_MONTO_LOCAL'
,p_attribute_01=>'PLSQL_EXPRESSION'
,p_attribute_04=>'SAF.APX_FNC_CONVERSION_MONEDAS(REPLACE(:P84006_MONTO_ORIGEN, '','', ''''), :P84006_CODIGO_MONEDA, 1, NVL(:P84006_TASA_CAMBIO, SAF.FNC_GET_TIPO_CAMBIO(:P84006_CODIGO_MONEDA)), NULL)'
,p_attribute_07=>'P84006_MONTO_ORIGEN,P84006_CODIGO_MONEDA,P84006_TASA_CAMBIO'
,p_attribute_08=>'Y'
,p_attribute_09=>'N'
,p_wait_for_result=>'Y'
...
,p_affected_elements=>'P84006_MONTO_MORA_LOCAL'
,p_attribute_01=>'PLSQL_EXPRESSION'
,p_attribute_04=>'SAF.APX_FNC_CONVERSION_MONEDAS(REPLACE(:P84006_MONTO_MORA_ORIGEN, '','', ''''), :P84006_CODIGO_MONEDA, 1, NVL(:P84006_TASA_CAMBIO, SAF.FNC_GET_TIPO_CAMBIO(:P84006_CODIGO_MONEDA)), NULL)'
,p_attribute_07=>'P84006_MONTO_MORA_ORIGEN,P84006_CODIGO_MONEDA,P84006_TASA_CAMBIO'
,p_attribute_08=>'Y'
,p_attribute_09=>'N'
,p_wait_for_result=>'Y'
...
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P84006_CODIGO_EMPRESA,P84006_TIPO_DESTINATARIO,P84006_ID_ASOCIACION,P84006_ES_PRESTAMO,P84006_CODIGO_MONEDA,P84006_TASA_CAMBIO,P84006_MONTO_ORIGEN,P84006_OBSERVACIONES,P84006_TIPO_PRESTAMO,P84006_MEDIDA_PLAZO,P84006_PLAZO,P84006_TIPO_TASA,P84006_TASA'
||'_INTERES,P84006_FECHA_COBRO,P84006_TIPO_COBRO_MORA,P84006_TIPO_MORA,P84006_PORCENTAJE_MORA,P84006_MONTO_MORA_ORIGEN,P84006_MONTO_MORA_LOCAL,P84006_FECHA_APROBACION'
);
wwv_flow_imp_page.create_page_da_action(
...
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'document.getElementById(''REGION_GENERAL'')',
'    .getElementsByClassName(''t-Region-bodyWrap'')[0]',
'    .getElementsByClassName(''t-Region-body'')[0].style.height = "740px";'))
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(356891687588227048)
,p_event_id=>wwv_flow_imp.id(214888486689634233)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'document.getElementById(''TAB_RUBROS'')',
'    .getElementsByClassName(''t-Region-bodyWrap'')[0]',
'    .getElementsByClassName(''t-Region-body'')[0].style.height = "740px";'))
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(356891769131227049)
,p_event_id=>wwv_flow_imp.id(214888486689634233)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'Y'
...
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'document.getElementById(''TAB_PAGOS'')',
'    .getElementsByClassName(''t-Region-bodyWrap'')[0]',
'    .getElementsByClassName(''t-Region-body'')[0].style.height = "740px";'))
,p_server_condition_type=>'EXPRESSION'
,p_server_condition_expr1=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(356891870610227050)
,p_event_id=>wwv_flow_imp.id(214888486689634233)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'Y'
...
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'document.getElementById(''TAB_AUDIT'')',
'    .getElementsByClassName(''t-Region-bodyWrap'')[0]',
'    .getElementsByClassName(''t-Region-body'')[0].style.height = "740px";'))
,p_server_condition_type=>'ITEM_IS_NOT_NULL'
,p_server_condition_expr1=>'P84006_ID'
);
wwv_flow_imp_page.create_page_da_event(
