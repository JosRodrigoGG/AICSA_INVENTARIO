...
,p_last_upd_yyyymmddhh24miss=>'20230919163544'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(204618710017859027)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(204618885842859028)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(204618472060859024)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(204618671372859026)
,p_name=>'P84008_ID'
,p_item_sequence=>20
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(204618900074859029)
,p_name=>'CANCELAR'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(204618710017859027)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(204619034352859030)
,p_event_id=>wwv_flow_imp.id(204618900074859029)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(204619180741859031)
,p_name=>'GUARDAR_REGISTRO'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(204618885842859028)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(204619439921859034)
,p_event_id=>wwv_flow_imp.id(204619180741859031)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_name=>'CARGAR_DATO'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(204619368508859033)
,p_event_id=>wwv_flow_imp.id(204619180741859031)
,p_event_result=>'TRUE'
