...
,p_last_upd_yyyymmddhh24miss=>'20230927104115'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(159998466039561023)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(159998531698561024)
,p_plug_name=>'LISTA'
,p_region_name=>'LISTA'
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(159998682110561025)
...
,p_internal_uid=>159998682110561025
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(189926814955710825)
,p_db_column_name=>'ID'
,p_display_order=>10
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(189926982459710826)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(189927076835710827)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(189927139859710828)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(189927293547710829)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(189927326159710830)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(189927440250710831)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(189927512213710832)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(189927682849710833)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(189927790785710834)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(189927850670710835)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(189927901801710836)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(189928067854710837)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(192821587475185605)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(209363614626316721)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(189690791117720131)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(159999065692561029)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(159998531698561024)
,p_button_name=>'CREAR'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(192558859332874145)
,p_name=>'P84005_URL'
,p_item_sequence=>30
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(192821456430185604)
,p_name=>'P84005_ID_TABLA'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(159998531698561024)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(192823748835185627)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(159998806400561027)
,p_name=>'LISTA'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(159998531698561024)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterrefresh'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(159998965768561028)
,p_event_id=>wwv_flow_imp.id(159998806400561027)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(209363715617316722)
,p_event_id=>wwv_flow_imp.id(159998806400561027)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(159999457996561033)
,p_name=>'CREAR_SOLICITUD'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(159999065692561029)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(159999580751561034)
,p_event_id=>wwv_flow_imp.id(159999457996561033)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192558947156874146)
,p_event_id=>wwv_flow_imp.id(159999457996561033)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
'    p_url => ''f?p=146:84006:&SESSION.:::84006:P84006_ACCION_MODAL:CREAR'',',
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192559021935874147)
,p_event_id=>wwv_flow_imp.id(159999457996561033)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(192558446473874141)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192558544052874142)
,p_event_id=>wwv_flow_imp.id(192558446473874141)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_name=>'REFRESH'
...
,p_affected_region_id=>wwv_flow_imp.id(159998531698561024)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192559198556874148)
,p_event_id=>wwv_flow_imp.id(192558446473874141)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(192821108063185601)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192821352712185603)
,p_event_id=>wwv_flow_imp.id(192821108063185601)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_name=>'ID'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192823640180185626)
,p_event_id=>wwv_flow_imp.id(192821108063185601)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192821234994185602)
,p_event_id=>wwv_flow_imp.id(192821108063185601)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(192823833961185628)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192824196939185631)
,p_event_id=>wwv_flow_imp.id(192823833961185628)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_name=>'URL'
...
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select apex_util.prepare_url (',
'    p_url => ''f?p=146:84006:&SESSION.:::84006:P84006_ACCION_MODAL,P84006_ID:MODIFICAR_SOLICITUD,'' || :P84005_ID_TABLA,',
'    p_triggering_element => ''apex.jQuery(''''#LISTA'''')'' ) url ',
'into :P84005_URL',
'FROM DUAL;'))
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192824295722185632)
,p_event_id=>wwv_flow_imp.id(192823833961185628)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(194153984628877117)
,p_name=>'VER_REGISTRO'
,p_event_sequence=>60
,p_triggering_element_type=>'JAVASCRIPT_EXPRESSION'
,p_triggering_element=>'document'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(194154006823877118)
,p_event_id=>wwv_flow_imp.id(194153984628877117)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_name=>'URL'
...
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select apex_util.prepare_url (',
'    p_url => ''f?p=146:84006:&SESSION.:::84006:P84006_ACCION_MODAL,P84006_ID:VER_REGISTRO,'' || :P84005_ID_TABLA,',
'    p_triggering_element => ''apex.jQuery(''''#LISTA'''')'' ) url ',
'into :P84005_URL',
'FROM DUAL;'))
,p_attribute_02=>'P84005_ID_TABLA'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(194154123906877119)
,p_event_id=>wwv_flow_imp.id(194153984628877117)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(194154993806877127)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(194155059129877128)
,p_event_id=>wwv_flow_imp.id(194154993806877127)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_name=>'URL'
...
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select apex_util.prepare_url (',
'    p_url => ''f?p=146:84006:&SESSION.:::84006:P84006_ACCION_MODAL,P84006_ID:INGRESAR_REGISTRO,'' || :P84005_ID_TABLA,',
'    p_triggering_element => ''apex.jQuery(''''#LISTA'''')'' ) url ',
'into :P84005_URL',
'FROM DUAL;'))
,p_attribute_02=>'P84005_ID_TABLA'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(194155198688877129)
,p_event_id=>wwv_flow_imp.id(194154993806877127)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(159999684070561035)
