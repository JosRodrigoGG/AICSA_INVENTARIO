...
,p_last_upd_yyyymmddhh24miss=>'20230922173001'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(192464034770293320)
,p_plug_name=>'FOS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(192464111900293321)
,p_plug_name=>'PERMISOS'
,p_parent_plug_id=>wwv_flow_imp.id(192464034770293320)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(192464683433293326)
,p_plug_name=>'General'
,p_parent_plug_id=>wwv_flow_imp.id(192464111900293321)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(192465096201293330)
,p_plug_name=>'&nbsp;'
,p_parent_plug_id=>wwv_flow_imp.id(192464111900293321)
,p_region_template_options=>'#DEFAULT#:is-expanded:t-Region--scrollBody'
,p_plug_template=>wwv_flow_imp.id(1583390108320677411)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(192464286608293322)
,p_plug_name=>'REGION'
,p_parent_plug_id=>wwv_flow_imp.id(192464034770293320)
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader:t-Region--textContent:t-Region--scrollBody'
,p_plug_template=>wwv_flow_imp.id(1861833776453083509)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(352508967730137824)
,p_plug_name=>'name_app'
,p_parent_plug_id=>wwv_flow_imp.id(192464286608293322)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(352509033389137825)
,p_plug_name=>'LISTA'
,p_region_name=>'LISTA'
,p_parent_plug_id=>wwv_flow_imp.id(192464286608293322)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(352509183801137826)
...
,p_internal_uid=>352509183801137826
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(192511120506576825)
,p_db_column_name=>'ID'
,p_display_order=>10
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(192463888075293318)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(192463970999293319)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(382201292808296932)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(192465837267293338)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(192464111900293321)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(192466179987293341)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(192465996055293339)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(192466053676293340)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(192516693352576853)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(352509033389137825)
,p_button_name=>'CREAR'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(192464501712293325)
,p_name=>'P84007_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(192464683433293326)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(192464815121293328)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(192464964468293329)
,p_name=>'P84007_FLUJO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(192464683433293326)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(192465123979293331)
,p_name=>'P84007_USUARIO_GRABACION'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(192465096201293330)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(192465218328293332)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(192465361379293333)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(192465442789293334)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(192554670024874103)
,p_name=>'P84007_ERROR'
,p_item_sequence=>30
,p_item_default=>'-1'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(192517797471576865)
,p_name=>'LISTA'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(352509033389137825)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterrefresh'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192518213720576867)
,p_event_id=>wwv_flow_imp.id(192517797471576865)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(209363898258316723)
,p_event_id=>wwv_flow_imp.id(192517797471576865)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(192464361673293323)
,p_name=>'INGRESAR_PERMISO'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(192516693352576853)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192555751396874114)
,p_event_id=>wwv_flow_imp.id(192464361673293323)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192926886960077019)
,p_event_id=>wwv_flow_imp.id(192464361673293323)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
,p_affected_region_id=>wwv_flow_imp.id(192465096201293330)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192464411640293324)
,p_event_id=>wwv_flow_imp.id(192464361673293323)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(192465556929293335)
,p_name=>'BLOQUEAR'
,p_event_sequence=>30
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192465682996293336)
,p_event_id=>wwv_flow_imp.id(192465556929293335)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_name=>'ITEMS'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192466252972293342)
,p_event_id=>wwv_flow_imp.id(192465556929293335)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
,p_affected_button_id=>wwv_flow_imp.id(192465837267293338)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192466391207293343)
,p_event_id=>wwv_flow_imp.id(192465556929293335)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'Y'
...
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(192466179987293341)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192466475463293344)
,p_event_id=>wwv_flow_imp.id(192465556929293335)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(192465996055293339)
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(192466522931293345)
,p_name=>'CANCELAR'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(192466053676293340)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192466608622293346)
,p_event_id=>wwv_flow_imp.id(192466522931293345)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_name=>'CERRAR_FOS'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192466752233293347)
,p_event_id=>wwv_flow_imp.id(192466522931293345)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(192554472846874101)
,p_name=>'GUARDAR'
,p_event_sequence=>50
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(192465837267293338)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192555141560874108)
,p_event_id=>wwv_flow_imp.id(192554472846874101)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192555463921874111)
,p_event_id=>wwv_flow_imp.id(192554472846874101)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192555072388874107)
,p_event_id=>wwv_flow_imp.id(192554472846874101)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192555553502874112)
,p_event_id=>wwv_flow_imp.id(192554472846874101)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192555652537874113)
,p_event_id=>wwv_flow_imp.id(192554472846874101)
,p_event_result=>'TRUE'
...
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(352509033389137825)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192555234467874109)
,p_event_id=>wwv_flow_imp.id(192554472846874101)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(192554758123874104)
,p_name=>'MENSAJE_ERROR'
,p_event_sequence=>60
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192554819535874105)
,p_event_id=>wwv_flow_imp.id(192554758123874104)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_name=>'ERROR'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192554915416874106)
,p_event_id=>wwv_flow_imp.id(192554758123874104)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(192555893669874115)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192555962692874116)
,p_event_id=>wwv_flow_imp.id(192555893669874115)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_name=>'ID'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192556371260874120)
,p_event_id=>wwv_flow_imp.id(192555893669874115)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192926991042077020)
,p_event_id=>wwv_flow_imp.id(192555893669874115)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192556172578874118)
,p_event_id=>wwv_flow_imp.id(192555893669874115)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(192556411626874121)
,p_name=>'EDITAR'
,p_event_sequence=>80
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(192466179987293341)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192556687920874123)
,p_event_id=>wwv_flow_imp.id(192556411626874121)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_name=>'CERRAR_FOS'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192556872960874125)
,p_event_id=>wwv_flow_imp.id(192556411626874121)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192556975466874126)
,p_event_id=>wwv_flow_imp.id(192556411626874121)
,p_event_result=>'TRUE'
,p_action_sequence=>50
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192556713309874124)
,p_event_id=>wwv_flow_imp.id(192556411626874121)
,p_event_result=>'TRUE'
,p_action_sequence=>70
,p_execute_on_page_init=>'N'
...
begin
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(192557047593874127)
,p_name=>'ELIMINAR'
,p_event_sequence=>90
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(192465996055293339)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192557218644874129)
,p_event_id=>wwv_flow_imp.id(192557047593874127)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_name=>'CERRAR_FOS'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192557343304874130)
,p_event_id=>wwv_flow_imp.id(192557047593874127)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192557411670874131)
,p_event_id=>wwv_flow_imp.id(192557047593874127)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(192557502244874132)
,p_event_id=>wwv_flow_imp.id(192557047593874127)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(192517329174576864)
