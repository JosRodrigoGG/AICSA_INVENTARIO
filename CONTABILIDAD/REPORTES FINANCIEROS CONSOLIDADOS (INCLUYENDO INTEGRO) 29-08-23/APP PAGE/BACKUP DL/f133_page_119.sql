...
--   Application:     133
--   Name:            Contabilidad
--   Date and Time:   14:57 Tuesday February 13, 2024
...
'var $wP;',
'',
'function traductorDatePicker(item){',
'    $(''#''+item+ ''_month option:contains("January")'').text(''Enero'');',
'    ',
'    $(''#''+item+ ''_month option:contains("February")'').text(''Febrero'');',
'    $(''#''+item+ ''_month option:contains("March")'').text(''Marzo'');',
'    $(''#''+item+ ''_month option:contains("April")'').text(''Abril'');',
'    $(''#''+item+ ''_month option:contains("May")'').text(''Mayo'');',
'    $(''#''+item+ ''_month option:contains("June")'').text(''Junio'');',
'    $(''#''+item+ ''_month option:contains("July")'').text(''Julio'');',
'    $(''#''+item+ ''_month option:contains("August")'').text(''Agosto'');',
'    $(''#''+item+ ''_month option:contains("September")'').text(''Septiembre'');',
'    $(''#''+item+ ''_month option:contains("October")'').text(''Octubre'');',
'    $(''#''+item+ ''_month option:contains("November")'').text(''Noviembre'');',
'    $(''#''+item+ ''_month option:contains("December")'').text(''Diciembre'');',
'}'))
,p_css_file_urls=>'#WORKSPACE_FILES#suite#MIN#.css'
,p_inline_css=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#CONCILACION_BANCARARIA .t-Card .t-Card-wrap .t-Card-titleWrap{',
'    height: 164px;',
'}',
'',
'#TIEMPOS_DE_APROBACION .t-Card-body, #CUMPLIMIENTO_PLAN_PAGOS .t-Card-body, #PERIODO_PAGO .t-Card-body,#ROTACION_CUENTAS_PAGAR .t-Card-body{',
'    display: flex;',
'    flex-direction: row;',
'}',
'',
'#DIV_TIEMPOS, #DIV_PLAN_PAGOS, #DIV_PERIODO_PAG, #DIV_ROTACION_CUENTAS_PAGAR {',
'    text-align: right;',
'}'))
...
,p_last_upd_yyyymmddhh24miss=>'20240213093731'
);
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(386256809602020221)
,p_plug_name=>'fecha_inicio'
,p_region_name=>'fecha_inicio'
,p_parent_plug_id=>wwv_flow_imp.id(1101487114631567925)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(386257179490020224)
,p_plug_name=>'fecha_fin'
,p_region_name=>'fecha_fin'
,p_parent_plug_id=>wwv_flow_imp.id(1101487114631567925)
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--removeHeader js-removeLandmark:t-Region--noUI:t-Region--scrollBody'
,p_plug_template=>wwv_flow_imp.id(99575797075243864)
...
'    TO_CHAR',
'    ( SAF.GET_INDICADOR_GERENCIAL_OPERACION_DIVISION',
'        (',
...
'WHERE ID = 5;'))
,p_ajax_enabled=>'Y'
,p_ajax_items_to_submit=>'P119_CODIGO_EMPRESA,P119_FECHA_INICIO,P119_FECHA_FIN,P119_VECTOR_EMPRESAS'
...
'    )',
'    AND TRUNC(A.FPOL) BETWEEN TO_DATE(:P119_FECHA_INICIO, ''DD/MM/YYYY'') AND TO_DATE(:P119_FECHA_FIN, ''DD/MM/YYYY'')',
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(421329440012181733)
,p_name=>'Nivel de Endeudamiento'
...
'        SELECT TO_NUMBER(C001) FROM APEX_COLLECTIONS WHERE COLLECTION_NAME = ''COLLECTION_EMPRESA''',
'    )',
'    AND A.COD_CTA LIKE ''2%''',
'    /*(',
'    	SELECT DISTINCT COD_CTA FROM SAF.CON_POLDETXHEAD WHERE COD_CTA LIKE ''2%''',
'    )*/',
'    AND TRUNC(FPOL) BETWEEN TRUNC(TO_DATE(:P119_FECHA_INICIO, ''DD/MM/YYYY'')) AND TRUNC(TO_DATE(:P119_FECHA_FIN, ''DD/MM/YYYY''))',
'   ',
'),',
'DATOS_EGRESO AS (',
'    SELECT ',
...
'    )',
'    ',
'    AND A.COD_CTA LIKE ''3%''',
'    /*(',
'    	SELECT DISTINCT COD_CTA FROM SAF.CON_POLDETXHEAD WHERE COD_CTA LIKE ''3%''',
'    )*/',
'    AND TRUNC(FPOL) BETWEEN TRUNC(TO_DATE(:P119_FECHA_INICIO, ''DD/MM/YYYY'')) AND TRUNC(TO_DATE(:P119_FECHA_FIN, ''DD/MM/YYYY''))',
'  ',
')',
...
'    ''U-COLOR-1'' CARD_COLOR,',
'    NULL AS CARD_SUBTEXT,',
'    APEX_UTIL.PREPARE_URL(p_url => ''javascript:detalleIndicador(20);'') AS CARD_LINK',
'FROM DUAL, SAF.CON_INDICADORES',
'WHERE ID = 20;'))
,p_ajax_enabled=>'Y'
,p_ajax_items_to_submit=>'P119_CODIGO_EMPRESA,P119_CODIGO_UNIDAD,P119_FECHA_INICIO,P119_FECHA_FIN'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(421329511162181734)
,p_query_column_id=>1
,p_column_alias=>'CARD_TITLE'
,p_column_display_sequence=>10
,p_column_heading=>'Card Title'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(421329698954181735)
,p_query_column_id=>2
,p_column_alias=>'CARD_SUBTITLE'
,p_column_display_sequence=>20
,p_column_heading=>'Card Subtitle'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(421329733667181736)
,p_query_column_id=>3
,p_column_alias=>'CARD_INITIALS'
,p_column_display_sequence=>30
,p_column_heading=>'Card Initials'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(421329845275181737)
,p_query_column_id=>4
,p_column_alias=>'CARD_TEXT'
,p_column_display_sequence=>40
,p_column_heading=>'Card Text'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(421329907659181738)
,p_query_column_id=>5
,p_column_alias=>'CARD_COLOR'
,p_column_display_sequence=>50
,p_column_heading=>'Card Color'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(421330014293181739)
,p_query_column_id=>6
,p_column_alias=>'CARD_SUBTEXT'
,p_column_display_sequence=>60
,p_column_heading=>'Card Subtext'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(421330129379181740)
,p_query_column_id=>7
,p_column_alias=>'CARD_LINK'
,p_column_display_sequence=>70
,p_column_heading=>'Card Link'
...
'    AND A.COD_CTA IN',
'    (',
'    	SELECT DISTINCT COD_CTA FROM SAF.CON_POLDETXHEAD WHERE COD_CTA LIKE ''11%'' ',
'    )',
'    AND TRUNC(FPOL) BETWEEN TO_DATE(:P119_FECHA_INICIO, ''DD/MM/YYYY'') AND TO_DATE(:P119_FECHA_FIN, ''DD/MM/YYYY'')',
'    ',
'),',
'DATOS_EGRESO AS (',
'    SELECT ',
...
'    AND A.COD_CTA IN',
'    (',
'    	SELECT DISTINCT COD_CTA FROM SAF.CON_POLDETXHEAD WHERE COD_CTA LIKE ''21%'' ',
'    )',
'    AND TRUNC(FPOL) BETWEEN TO_DATE(:P119_FECHA_INICIO, ''DD/MM/YYYY'') AND TO_DATE(:P119_FECHA_FIN, ''DD/MM/YYYY'')',
'    ',
')',
...
'    	--A.ID,',
'      ',
'    	(GET_CARDINALIDAD_CUENTA_CONTABLE(A.COD_CTA,A.VALOR,A.DB_HB,2020) * -1) AS SALDO',
'    FROM SAF.CON_POLDETXHEAD A',
'    WHERE A.CODIGO_EMPRESA IN ',
'    (',
'        SELECT TO_NUMBER(C001) FROM APEX_COLLECTIONS WHERE COLLECTION_NAME = ''COLLECTION_EMPRESA''',
...
'    TO_CHAR',
'    (',
'        SAF.GET_INDICADOR_GERENCIAL_PERIODO_DE_COBRO',
'        (',
'            (SELECT LISTAGG(C001, ''|'') FROM APEX_COLLECTIONS WHERE COLLECTION_NAME = ''COLLECTION_EMPRESA''),',
'            TO_DATE(:P119_FECHA_INICIO, ''DD/MM/YYYY''),',
'            TO_DATE(:P119_FECHA_FIN, ''DD/MM/YYYY'')',
'        )',
'    , ''999G999G999G999G990D00'') || '' Dias'' AS CARD_SUBTITLE,',
...
,p_region_name=>'ROTACION_CUENTAS_PAGAR'
,p_parent_plug_id=>wwv_flow_imp.id(1149143791121916105)
,p_template=>wwv_flow_imp.id(99575797075243864)
,p_display_sequence=>30
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--removeHeader js-removeLandmark:t-Region--noBorder:t-Region--scrollBody'
...
'(',
'    SELECT',
'        FNC_CXP_TRANSACCIONES_SUMA_SALDO_INICIAL(:P119_VECTOR_EMPRESAS, :P119_FECHA_INICIO, :P119_INTERCOMPANY) AS SALDO',
'    FROM DUAL',
'),',
'DATOS_SALDO_FIN AS ',
'(',
'    SELECT',
'        FNC_CXP_TRANSACCIONES_SUMA_SALDO_FINAL(:P119_VECTOR_EMPRESAS, :P119_FECHA_FIN, :P119_INTERCOMPANY) AS SALDO',
'    FROM DUAL',
'),',
...
'    )',
'   -- AND A.FECHA_TRANSACCION BETWEEN TO_DATE(:P119_FECHA_INICIO, ''DD/MM/YYYY'') AND TO_DATE(:P119_FECHA_FIN, ''DD/MM/YYYY'')',
'     AND TO_DATE(A.FECHA_TRANSACCION,''DD/MM/YYYY'') BETWEEN TO_DATE(:P119_FECHA_INICIO,''DD/mm/yyyy'') AND TO_DATE(:P119_FECHA_FIN,''DD/mm/yyyy'')',
'    ',
')',
'SELECT',
'    INDICADOR AS CARD_TITLE,',
...
'-- CAMBIO SIN REVISAR DMLOPEZ',
'SELECT AVG(PROMEDIOXMESXANIOXCUENTA) PROMEDIO_GENERAL , MES, ANIO FROM (',
'        SELECT AVG(DIAS) PROMEDIOXMESXANIOXCUENTA, NUMERO_CUENTA, MES, ANIO FROM',
'        (',
'                        SELECT ',
'                            CT.NUMERO_CUENTA ,',
'                            CT.CODIGO_PROYECTO,',
'                            to_number(to_char(ct.FECHA_TRANSACCION,''MM'')) MES,',
'                            TO_NUMBER(to_char(ct.FECHA_TRANSACCION,''YYYY'')) AS ANIO,',
...
'                SELECT TO_NUMBER(C001) FROM APEX_COLLECTIONS WHERE COLLECTION_NAME = ''COLLECTION_EMPRESA''',
'            )',
'        AND TRUNC(CT.FECHA_TRANSACCION) BETWEEN TO_DATE(:P119_FECHA_INICIO, ''DD/MM/YYYY'') AND TO_DATE(:P119_FECHA_FIN, ''DD/MM/YYYY'')',
'    )GROUP BY NUMERO_CUENTA,mes,ANIO)  GROUP BY MES, ANIO',
'',
')',
'SELECT',
'    INDICADOR AS CARD_TITLE,',
'    TO_CHAR',
'    (',
'        NVL((SELECT SUM(PROMEDIO_GENERAL) FROM DIAS), 0) /',
'        (TRUNC',
'        (',
'            MONTHS_BETWEEN',
'            (',
...
'    )',
'    ',
'    AND TO_DATE(FECHA_TRANSACCION,''DD/MM/YYYY'') BETWEEN TO_DATE(:P119_FECHA_INICIO,''DD/mm/yyyy'') AND TO_DATE(:P119_FECHA_FIN,''DD/mm/yyyy'')',
'    --AND A.FECHA_TRANSACCION BETWEEN TO_DATE(:P119_FECHA_INICIO, ''DD/MM/YYYY'') AND TO_DATE(:P119_FECHA_FIN, ''DD/MM/YYYY'')',
')',
'SELECT',
'    INDICADOR AS CARD_TITLE,',
...
,p_region_name=>'TIEMPOS_DE_APROBACION'
,p_parent_plug_id=>wwv_flow_imp.id(1149143791121916105)
,p_template=>wwv_flow_imp.id(99575797075243864)
...
,p_region_name=>'CUMPLIMIENTO_PLAN_PAGOS'
,p_parent_plug_id=>wwv_flow_imp.id(1149143791121916105)
,p_template=>wwv_flow_imp.id(99575797075243864)
...
'    SELECT',
'        COUNT(ROWID) TOTAL',
'    FROM SAF.FLUJO_CXP_ANTIGUEDAD',
'    WHERE CODIGO_EMPRESA IN',
'    (',
'        SELECT TO_NUMBER(C001) FROM APEX_COLLECTIONS WHERE COLLECTION_NAME = ''COLLECTION_EMPRESA''    ',
'    )',
'    AND (NVL(TREINTA, 0) + NVL(SESENTA, 0) + NVL(MAXSESENTA, 0)) >= 1',
'    AND TRUNC(FECHA_TRANSACCION) BETWEEN TRUNC(TO_DATE(:P119_FECHA_INICIO, ''DD/MM/YYYY'')) AND TRUNC(TO_DATE(:P119_FECHA_FIN, ''DD/MM/YYYY''))',
'    AND (NVL(MONTO_APLICADO_QTZ, 0) > 0 OR NVL(MONTO_APLICADO_USD, 0) > 0)',
'),',
'PAGOS_PAGADOS AS',
'(',
'    SELECT',
...
'    INNER JOIN SAF.PRS_DOCTOS_PRESUPUESTO B',
'        ON B.CODIGO_EMPRESA = A.CODIGO_EMPRESA',
'        AND B.CODIGO_CC = A.CODIGO_CC',
'        AND B.SERIE_DOCUMENTO = A.SERIE_DOCUMENTO',
'        AND B.NUMERO_DOCUMENTO = A.NUMERO_DOCUMENTO',
'        AND B.CODIGO_PROVEEDOR = A.CODIGO_PROVEEDOR',
'    INNER JOIN SAF.PRS_TRANSFERENCIAS_DET D',
'        ON D.CODIGO_EMPRESA = B.CODIGO_EMPRESA',
'        AND D.CODIGO_PROVEEDOR = B.CODIGO_PROVEEDOR',
'        AND D.REFERENCIA = B.CODIGO_PRESUPUESTO',
'    WHERE A.CODIGO_EMPRESA IN',
'    (',
'        SELECT TO_NUMBER(C001) FROM APEX_COLLECTIONS WHERE COLLECTION_NAME = ''COLLECTION_EMPRESA''',
'    )',
'    AND TRUNC(A.FECHA_TRANSACCION) BETWEEN TRUNC(TO_DATE(:P119_FECHA_INICIO, ''DD/MM/YYYY'')) AND TRUNC(TO_DATE(:P119_FECHA_FIN, ''DD/MM/YYYY''))',
...
'    (',
'        CASE',
'            WHEN (SELECT NVL(SUM(TOTAL), 0) FROM PAGOS_APLICADOS) = 0 THEN',
'                0',
'            ELSE',
'                100 * ((SELECT NVL(SUM(TOTAL), 0) FROM PAGOS_PAGADOS) / (SELECT NVL(SUM(TOTAL), 0) FROM PAGOS_APLICADOS))',
'        END',
'    , ''999G999G999G999G990D00'') || '' %'' AS CARD_SUBTITLE,',
'    NULL AS CARD_INITIALS,',
'    TIPO AS CARD_TEXT,',
...
,p_query_type=>'SQL'
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'WITH TODOS_DOCUMENTOS AS (',
'    SELECT ',
'        DECODE(COUNT(*),0,1,COUNT(*)) DOCUMENTOS',
'    FROM SAF.BCOMOVIG',
...
'    	SELECT TO_NUMBER(C001) FROM APEX_COLLECTIONS WHERE COLLECTION_NAME = ''COLLECTION_EMPRESA''',
'    )',
'    AND TRUNC(FEDOC) BETWEEN TRUNC(TO_DATE(:P119_FECHA_INICIO, ''DD/MM/YYYY'')) AND TRUNC(TO_DATE(:P119_FECHA_FIN, ''DD/MM/YYYY''))',
'),',
'DOCUMENTOS_CONCILIADOS AS (',
'    SELECT ',
'        SERIE,',
'        NUMDOC,',
'    	CASE',
...
'                CASE ',
'                    WHEN TRUNC(FPAGADO) <= TO_DATE(:P119_FECHA_FIN, ''DD/MM/YYYY'') THEN 1',
'                    ELSE 0',
'                END',
'            ELSE 0 ',
'        END AS CONCILIADOS',
...
'        NVL((',
'            SELECT(',
'                ((SELECT SUM(CONCILIADOS) FROM DOCUMENTOS_CONCILIADOS)',
'                /(SELECT DOCUMENTOS FROM TODOS_DOCUMENTOS))*100)',
'            FROM DUAL',
'        ),0)',
'    , ''999G999G999G999G990D00'')|| '' %'' AS CARD_SUBTITLE,',
'    NULL AS CARD_INITIALS,',
...
'WHERE ID = 7;'))
,p_ajax_enabled=>'Y'
,p_ajax_items_to_submit=>'P119_FECHA_INICIO,P119_FECHA_FIN,P119_CODIGO_EMPRESA'
,p_lazy_loading=>false
,p_query_row_template=>wwv_flow_imp.id(99606046125243943)
,p_query_num_rows=>15
,p_query_options=>'DERIVED_REPORT_COLUMNS'
...
,p_button_static_id=>'buscar_datos'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(386257222565020225)
...
'apex.item(''P119_FECHA_FIN'').setValue($("#fecha_fin input").val());',
'apex.item(''P119_FECHA_INICIO'').setValue($("#fecha_inicio input").val());'))
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(421330632664181745)
,p_event_id=>wwv_flow_imp.id(1102791520288595426)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(421329440012181733)
);
wwv_flow_imp_page.create_page_da_action(
...
'console.log(empresas.toString());',
'',
'var url = `f?p=&APP_ID.:131:&APP_SESSION.::NO:131:P131_FECHA_FIN,P131_FECHA_INICIO,P131_EMPRESA,P131_TIPO_INDICADOR:${fin},${inicio},[${empresas}],${indicador}`;',
'apex.server.process("PREPARE_URL", {',
'    x01: url',
'}, {',
'success: function(pData) {',
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(404180049387318702)
,p_name=>'INTERCOMPANY_tiempos'
,p_event_sequence=>200
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(1149145214485916120)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterrefresh'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(404180184029318703)
,p_event_id=>wwv_flow_imp.id(404180049387318702)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
'$(''#DIV_TIEMPOS'').remove();',
'',
'$("#TIEMPOS_DE_APROBACION_cards div.t-Card-body").append("<div id=''DIV_TIEMPOS'' class=''t-Card-desc''>Intercompany</div>")'))
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(404180236361318704)
,p_name=>'INTERCOMPANY PLAN PAGOS'
,p_event_sequence=>210
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(1149147730954916145)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterrefresh'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(404180350658318705)
,p_event_id=>wwv_flow_imp.id(404180236361318704)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'//$(''#CUMPLIMIENTO_PLAN_PAGOS'').remove();',
'',
'$("#CUMPLIMIENTO_PLAN_PAGOS_cards div.t-Card-body").append("<div id=''DIV_PLAN_PAGOS'' class=''t-Card-desc''>Intercompany</div>")'))
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(404180451119318706)
,p_name=>'INTERCOMPANY PERIODO_PAGO'
,p_event_sequence=>220
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(1149144290637916110)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterrefresh'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(404180501990318707)
,p_event_id=>wwv_flow_imp.id(404180451119318706)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'$(''#DIV_PERIODO_PAGO'').remove();',
'',
'$("#PERIODO_PAGO_cards div.t-Card-body").append("<div id=''DIV_PERIODO_PAGO'' class=''t-Card-desc''>Intercompany</div>")'))
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(404180604120318708)
,p_name=>'INTERCOMPANY CUENTAS POR PAGAR'
,p_event_sequence=>230
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(1145627361330797222)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterrefresh'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(404180761688318709)
,p_event_id=>wwv_flow_imp.id(404180604120318708)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'$(''#DIV_ROTACION_CUENTAS_PAGAR'').remove();',
'',
'$("#ROTACION_CUENTAS_PAGAR_cards div.t-Card-body").append("<div id=''DIV_ROTACION_CUENTAS_PAGAR'' class=''t-Card-desc''>Intercompany</div>")'))
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(421330235927181741)
,p_name=>'MODAL_DETALLE_NIVEL_ENDEUDAMIENTO'
...
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'custom'
,p_bind_event_type_custom=>'MODAL_DETALLE_NIVEL_ENDEUDAMIENTO'
);
end;
/
begin
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(421330421284181743)
,p_event_id=>wwv_flow_imp.id(421330235927181741)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
'console.log(empresas.toString());',
'',
'var url = `f?p=&APP_ID.:91012:&APP_SESSION.::NO:91012:P91012_FECHA_FIN,P91012_FECHA_INICIO,P91012_EMPRESA,P91012_TIPO_INDICADOR:${fin},${inicio},[${empresas}],${indicador}`;',
'apex.server.process("PREPARE_URL", {',
'    x01: url',
'}, {',
'success: function(pData) {',
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(421330538464181744)
,p_event_id=>wwv_flow_imp.id(421330235927181741)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
