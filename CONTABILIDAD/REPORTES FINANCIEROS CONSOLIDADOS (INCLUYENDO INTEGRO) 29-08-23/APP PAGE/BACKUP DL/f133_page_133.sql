...
--   Application:     133
--   Name:            Contabilidad
--   Date and Time:   15:09 Tuesday February 13, 2024
...
,p_alias=>'MODAL-DETALLE-ROTACION-CUENTA-PAGAR'
,p_page_mode=>'MODAL'
,p_step_title=>'.'
...
'td[headers="C1152030493341579596"],',
'td[headers="C1152035622946579603"],',
'td[headers="C1152030831327579596"],',
'td[headers="C1152031293116579597"],',
'td[headers="C1152031624891579597"],',
'td[headers="C1152032087546579598"],',
'td[headers="C1152032425574579599"],',
'td[headers="C1152032873179579599"],',
'td[headers="C1152033245321579600"],',
'td[headers="C1152033653107579600"],',
'td[headers="C1152034064575579601"],',
'td[headers="C1152034451389579601"]',
'{',
'    width: 100px !important;',
'    min-width: 100px !important;',
'}',
'',
'td[headers="C1152037219908579605"]',
'{',
...
'}',
'',
'td[headers="C1152034892223579602"]',
'{',
...
,p_last_upd_yyyymmddhh24miss=>'20231120110027'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4497575735710668833)
...
,p_ajax_items_to_submit=>'P133_TIPO_INDICADOR'
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(4497575806464668834)
...
,p_internal_uid=>4497575806464668834
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1152036441866579604)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1152036877340579605)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1152037219908579605)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1152037676781579606)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1152029287498579594)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1152029604898579594)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1152030071797579595)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1152030493341579596)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1152030831327579596)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1152031293116579597)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1152031624891579597)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1152032087546579598)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1152032425574579599)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1152032873179579599)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1152033245321579600)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1152033653107579600)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1152034064575579601)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1152034451389579601)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1152034892223579602)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1152035236247579603)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1152035622946579603)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1152036047184579604)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(4500538800884015536)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4501024434205110724)
,p_plug_name=>'FILTROS'
,p_parent_plug_id=>wwv_flow_imp.id(4497575735710668833)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1149144109276916109)
,p_name=>'P133_INTERCOMPANY'
,p_item_sequence=>70
,p_item_default=>'N'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1152038698944579610)
,p_name=>'P133_FILTROS_NIVEL'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(4501024434205110724)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1152039083928579611)
,p_name=>'P133_FECHA_INICIO'
,p_item_sequence=>10
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1152039484704579611)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1152039812407579612)
,p_name=>'P133_EMPRESA'
,p_item_sequence=>30
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1152040275379579612)
,p_name=>'P133_UNIDAD'
,p_item_sequence=>40
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1152040552914579613)
,p_name=>'P133_TIPO_INDICADOR'
,p_item_sequence=>50
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1152040966368579613)
,p_name=>'P133_NOMBRE_INDICADOR'
,p_item_sequence=>60
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1152043706403579630)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1152044285606579631)
,p_event_id=>wwv_flow_imp.id(1152043706403579630)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P133_NOMBRE_INDICADOR'
,p_attribute_01=>'FUNCTION_BODY'
,p_attribute_06=>wwv_flow_string.join(wwv_flow_t_varchar2(
'DECLARE',
'    CURSOR C_DATO IS',
'        SELECT INDICADOR FROM SAF.CON_INDICADORES WHERE ID = :P133_TIPO_INDICADOR;',
'    ',
...
'END;'))
,p_attribute_07=>'P133_TIPO_INDICADOR'
,p_attribute_08=>'Y'
,p_attribute_09=>'N'
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1152044784799579631)
,p_event_id=>wwv_flow_imp.id(1152043706403579630)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attribute_01=>'apex.util.getTopApex().jQuery(".INDICADOR_DETALLES .ui-dialog-title").text(apex.item(''P133_NOMBRE_INDICADOR'').getValue());'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1152045143543579632)
,p_name=>'AFTER_REFRESH_BALANCE_FILTRADO'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(4497575735710668833)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterrefresh'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1152045669911579632)
,p_event_id=>wwv_flow_imp.id(1152045143543579632)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1152046996821579633)
,p_name=>'FILTRO_NIVELES'
,p_event_sequence=>30
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P133_FILTROS_NIVEL'
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'change'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1152047452616579634)
,p_event_id=>wwv_flow_imp.id(1152046996821579633)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1152047810970579634)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1152048316067579635)
,p_event_id=>wwv_flow_imp.id(1152047810970579634)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'var dato = apex.item( "P133_FILTROS_NIVEL" ).getValue();',
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1152048843152579635)
,p_event_id=>wwv_flow_imp.id(1152047810970579634)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1152046011429579632)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1152046500550579633)
,p_event_id=>wwv_flow_imp.id(1152046011429579632)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P133_FILTROS_NIVEL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1152042589503579624)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1152042917860579624)
...
'                    (',
'                        SELECT ',
'                            REPLACE(REPLACE(REGEXP_SUBSTR(:P133_EMPRESA, ''[^\|]+'', 1, level), ''['',''''), '']'', '''') AS CODIGO_EMPRESA',
'                        FROM ',
'                            dual CONNECT BY REGEXP_SUBSTR(:P133_EMPRESA, ''[^\|]+'', 1, level) IS NOT NULL',
'                    )',
...
'    V_TOTAL NUMBER := 0;',
'    V_DATE_INICIO DATE := TO_DATE(:P133_FECHA_INICIO, ''DD/MM/YYYY'');',
'    V_DATE_FINAL DATE := TRUNC(LAST_DAY(TO_DATE(:P133_FECHA_INICIO, ''DD/MM/YYYY'')));',
'BEGIN',
'    V_VECTOR := ''['';',
...
'    CLOSE C_VERSION;',
'',
'    SELECT EXTRACT(YEAR FROM TO_DATE(:P133_FECHA_FIN, ''DD/MM/YYYY'')) - EXTRACT(YEAR FROM TO_DATE(:P133_FECHA_INICIO, ''DD/MM/YYYY'')) + 1 INTO V_CONJUNTOS FROM DUAL;',
'',
'    WHILE V_CONJUNTOS != 0',
'    LOOP',
'        V_CONTADOR := 0;',
...
'        V_CODIGO := ( TO_NUMBER(EXTRACT(YEAR FROM TO_DATE(:P133_FECHA_FIN, ''DD/MM/YYYY''))) - V_CONJUNTOS );',
'',
...
'        LOOP',
'            CASE ',
'                WHEN TO_CHAR(TO_DATE(:P133_FECHA_INICIO, ''DD/MM/YYYY''), ''YYYY'') = V_CODIGO ',
'                   AND V_DATE_INICIO <= last_day(to_date(:P133_FECHA_FIN,''DD/mm/yyyy'')) THEN',
'                    CASE',
'                        WHEN TO_NUMBER(TO_CHAR(TO_DATE(:P133_FECHA_INICIO, ''DD/MM/YYYY''), ''MM'')) <= V_MES THEN',
'                                SELECT FNC_CXP_TRANSACCIONES_SUMA_SALDO_INICIAL(:P133_EMPRESA, TO_CHAR(V_DATE_INICIO, ''DD/MM/YYYY''), :P133_INTERCOMPANY) INTO V_TOTAL FROM DUAL;',
'',
...
'                            );',
'                    END CASE;',
'                WHEN TO_CHAR(TO_DATE(:P133_FECHA_FIN, ''DD/MM/YYYY''), ''YYYY'') = V_CODIGO ',
'                    AND V_DATE_INICIO <= last_day(to_date(:P133_FECHA_FIN,''DD/mm/yyyy'')) THEN',
'                    CASE',
'                        WHEN TO_NUMBER(TO_CHAR(TO_DATE(:P133_FECHA_FIN, ''DD/MM/YYYY''), ''MM'')) >= V_MES THEN',
'                            SELECT FNC_CXP_TRANSACCIONES_SUMA_SALDO_INICIAL(:P133_EMPRESA,  TO_CHAR(V_DATE_INICIO, ''DD/MM/YYYY''), :P133_INTERCOMPANY) INTO V_TOTAL FROM DUAL;',
'                            ',
'                            APEX_COLLECTION.UPDATE_MEMBER_ATTRIBUTE (',
'                                p_collection_name => ''COLLECTION_DETALLE'',',
...
'                ELSE',
'                    IF ',
'                    V_DATE_INICIO <= last_day(to_date(:P133_FECHA_FIN,''DD/mm/yyyy'')) THEN',
'                        SELECT FNC_CXP_TRANSACCIONES_SUMA_SALDO_INICIAL(:P133_EMPRESA,  TO_CHAR(V_DATE_INICIO, ''DD/MM/YYYY''), :P133_INTERCOMPANY) INTO V_TOTAL FROM DUAL;',
'',
'                        APEX_COLLECTION.UPDATE_MEMBER_ATTRIBUTE (',
'                            p_collection_name => ''COLLECTION_DETALLE'',',
...
begin
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1152042170717579619)
...
'            CASE ',
'                 WHEN TO_CHAR(TO_DATE(:P133_FECHA_INICIO, ''DD/MM/YYYY''), ''YYYY'') = V_CODIGO ',
'                    AND V_DATE_FINAL <= LAST_DAY(TO_DATE(:P133_FECHA_INICIO,''DD/MM/YYYY'')) THEN',
'                    CASE',
'                        WHEN TO_NUMBER(TO_CHAR(TO_DATE(:P133_FECHA_INICIO, ''DD/MM/YYYY''), ''MM'')) <= V_MES THEN',
'                            SELECT SAF.FNC_CXP_TRANSACCIONES_SUMA_SALDO_FINAL(:P133_EMPRESA, TO_CHAR(V_DATE_FINAL, ''DD/MM/YYYY''), :P133_INTERCOMPANY) INTO V_TOTAL FROM DUAL;',
'',
'',
'                            APEX_COLLECTION.UPDATE_MEMBER_ATTRIBUTE (',
'                                p_collection_name => ''COLLECTION_DETALLE'',',
...
'                            );',
'                    END CASE;',
'                 WHEN TO_CHAR(TO_DATE(:P133_FECHA_FIN, ''DD/MM/YYYY''), ''YYYY'') = V_CODIGO THEN',
'                    CASE',
'                        WHEN TO_NUMBER(TO_CHAR(TO_DATE(:P133_FECHA_FIN, ''DD/MM/YYYY''), ''MM'')) >= V_MES THEN',
'                            IF TO_NUMBER(TO_CHAR(TO_DATE(:P133_FECHA_FIN, ''DD/MM/YYYY''), ''MM'')) = TO_NUMBER(TO_CHAR(TO_DATE(V_DATE_FINAL, ''DD/MM/YYYY''), ''MM'')) THEN',
'                                SELECT SAF.FNC_CXP_TRANSACCIONES_SUMA_SALDO_FINAL(:P133_EMPRESA, :P133_FECHA_FIN, :P133_INTERCOMPANY) INTO V_TOTAL FROM DUAL;',
'                            ELSE',
'                                 SELECT SAF.FNC_CXP_TRANSACCIONES_SUMA_SALDO_FINAL(:P133_EMPRESA, TO_CHAR(V_DATE_FINAL, ''DD/MM/YYYY''), :P133_INTERCOMPANY) INTO V_TOTAL FROM DUAL;',
'                            ',
'                            END IF;',
...
'                                p_attr_value  =>',
'                                (',
'                                     CASE WHEN TO_NUMBER(TO_CHAR(TO_DATE(:P133_FECHA_FIN, ''DD/MM/YYYY''), ''MM'')) = TO_NUMBER(TO_CHAR(TO_DATE(V_DATE_FINAL, ''DD/MM/YYYY''), ''MM'')) THEN',
'                                         LAST_DAY(TO_DATE(:P133_FECHA_FIN,''DD/MM/YYYY''))',
'                                        ',
'                                    ELSE',
'                                        V_DATE_FINAL',
'                                    END',
...
'                            V_DATE_FINAL := LAST_DAY(TRUNC(LAST_DAY(V_DATE_FINAL)) + 1);',
'                        ELSE',
'                            IF V_DATE_FINAL <= LAST_DAY(TO_DATE(:P133_FECHA_FIN,''DD/MM/YYYY'')) THEN',
'                                APEX_COLLECTION.UPDATE_MEMBER_ATTRIBUTE (',
'                                    p_collection_name => ''COLLECTION_DETALLE'',',
'                                    p_seq => V_SEQ_ID_FINAL,',
'                                    p_attr_number => V_UPDATE,',
...
'                    END CASE;',
'                ELSE',
'                    IF V_DATE_FINAL <=LAST_DAY(TO_DATE(:P133_FECHA_FIN,''MM/YYYY''))',
'                        OR (TO_CHAR(TO_DATE(V_DATE_FINAL, ''MM/YYYY''), ''YYYY'') = V_CODIGO AND TO_CHAR(TO_DATE(V_DATE_FINAL, ''MM/YYYY''), ''MM'') = TO_CHAR(TO_DATE(:P133_FECHA_FIN, ''DD/MM/YYYY''), ''MM'')) THEN',
'                        SELECT SAF.FNC_CXP_TRANSACCIONES_SUMA_SALDO_FINAL(:P133_EMPRESA, TO_CHAR(V_DATE_FINAL, ''MM/YYYY''), :P133_INTERCOMPANY) INTO V_TOTAL FROM DUAL;',
'',
'                        APEX_COLLECTION.UPDATE_MEMBER_ATTRIBUTE (',
'                            p_collection_name => ''COLLECTION_DETALLE'',',
'                            p_seq => V_SEQ_ID_FINAL,',
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1152041386680579614)
...
'                    	CODIGO_GASTO,',
'                    	(',
'                    		TREINTA + SESENTA + MAXSESENTA',
'                    	) SALDO,',
'                    	(',
'                    		TO_NUMBER(TO_CHAR(FECHA_TRANSACCION, ''MM'')) ',
'                    	) MES',
'                    FROM SAF.VW_CXP_PERIODO_PAGO_PROVEEDORES',
'                    WHERE CODIGO_EMPRESA IN',
'                    (',
'                    	SELECT ',
'                            TO_NUMBER(REPLACE(REPLACE(REGEXP_SUBSTR(:P133_EMPRESA, ''[^\|]+'', 1, level), ''['',''''), '']'', '''')) AS CODIGO_EMPRESA',
'                        FROM ',
'                            dual CONNECT BY REGEXP_SUBSTR(:P133_EMPRESA, ''[^\|]+'', 1, level) IS NOT NULL',
'                    )',
...
'                                (',
'                                    CASE',
'                                        WHEN NVL(:P133_INTERCOMPANY,''N'') = ''N'' THEN',
'                                            CASE',
...
'                    )',
'                    AND TO_NUMBER(TO_CHAR(FECHA_TRANSACCION, ''YYYY'')) = V_CODIGO',
'                    AND TRUNC(FECHA_TRANSACCION) BETWEEN TO_DATE(:P133_FECHA_INICIO, ''DD/MM/YYYY'') AND LAST_DAY(TO_DATE(:P133_FECHA_FIN,''DD/MM/YYYY''))',
'                ),',
'                GASTOS_RESUMIDOS AS',
'                (',
'                    SELECT',
...
'                );',
'            ',
'            V_NOMBRE_GASTO VARCHAR2(200) := NULL;',
'        BEGIN',
...
begin
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1152043366536579628)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1152041757513579617)
...
'                    p_attr_value  =>',
'                    (',
'                        CASE WHEN TO_NUMBER(V_SUB_SALDO) != 0 THEN',
'                            CASE',
'                                WHEN :P133_TIPO_INDICADOR = 12 AND TO_NUMBER(V_SUB_SALDO) != 0 THEN',
'                                    TO_NUMBER(V_SUB_VENTAS) / TO_NUMBER(V_SUB_SALDO)',
'                                WHEN :P133_TIPO_INDICADOR = 10 AND TO_NUMBER(V_SUB_SALDO) != 0 THEN',
'                                    (TO_NUMBER(V_SUB_VENTAS) / TO_NUMBER(V_SUB_SALDO)) * 365',
'                                ELSE',
'                                    0',
'                            END',
'                        ELSE',
...
'    V_VENTAS NUMBER := 0;',
'BEGIN',
'    SELECT FNC_CXP_TRANSACCIONES_SUMA_SALDO_INICIAL(:P133_EMPRESA, :P133_FECHA_INICIO, :P133_INTERCOMPANY) INTO V_INICIO FROM DUAL;',
'',
'    SELECT SAF.FNC_CXP_TRANSACCIONES_SUMA_SALDO_FINAL(:P133_EMPRESA, :P133_FECHA_FIN, :P133_INTERCOMPANY) INTO V_FINAL FROM DUAL;',
'',
'    SELECT',
'        NVL(SUM(SALDO), 0) INTO V_VENTAS',
'    FROM',
'    (',
'        SELECT',
'        	(',
...
'                CASE',
'                    WHEN :P133_TIPO_INDICADOR = 12 AND (V_INICIO + V_FINAL) != 0 THEN',
'                        V_VENTAS / ((V_INICIO + V_FINAL) / 2)',
'                    WHEN :P133_TIPO_INDICADOR = 10 AND (V_INICIO + V_FINAL) != 0 THEN',
'                        365 * (V_VENTAS / ((V_INICIO + V_FINAL) / 2))',
'                    ELSE',
'                        0',
'                END',
'            ELSE',
