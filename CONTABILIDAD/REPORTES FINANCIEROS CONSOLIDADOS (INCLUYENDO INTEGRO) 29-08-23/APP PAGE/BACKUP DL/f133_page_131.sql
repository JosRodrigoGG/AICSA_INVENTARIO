...
--   Application:     133
--   Name:            Contabilidad
--   Date and Time:   15:07 Tuesday February 13, 2024
...
wwv_flow_imp_page.create_page(
 p_id=>131
,p_name=>'INDICADOR_DETALLES_DIVISION_SIMPLE'
,p_alias=>'INDICADOR-DETALLES-DIVISION-SIMPLE'
,p_page_mode=>'MODAL'
,p_step_title=>' '
...
'td[headers="C1118239668429117748"],',
'td[headers="C1118240023408117749"],',
'td[headers="C1118240477065117750"],',
'td[headers="C1118240852706117750"],',
'td[headers="C1118241275344117751"],',
'td[headers="C1118241695340117752"],',
'td[headers="C1118242061863117752"],',
'td[headers="C1118242445367117753"],',
'td[headers="C1118242896461117754"],',
'td[headers="C1118243248566117754"],',
'td[headers="C1118243601688117755"],',
'td[headers="C1118244092899117756"],',
'td[headers="C1118244498684117757"]',
'{',
'    width: 100px !important;',
'    min-width: 100px !important;',
'}',
'',
'td[headers="C1118238841894117747"]',
'{',
...
,p_last_upd_yyyymmddhh24miss=>'20231122145003'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2221326402253365233)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(2221328583514365255)
...
,p_internal_uid=>2221328583514365255
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1118235844972117734)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1118236205100117735)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1118236699812117735)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1118237082104117736)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(2224093359048404495)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2221329440261365263)
,p_plug_name=>'Balance General'
...
'    ''RESULTADO'' AS TIPO,',
'    (',
'        CASE WHEN :P131_TIPO_INDICADOR = 5 THEN',
'            TO_CHAR(',
'                CASE WHEN (SELECT NVL((SUM(ENERO)),0) FROM SUMA_EGRESOS) = 0 THEN',
'                    0',
'                ELSE',
'                    ((SELECT NVL((SUM(ENERO)),0) FROM SUMA_INGRESO) / (SELECT NVL((SUM(ENERO)),0) FROM SUMA_EGRESOS))',
'                END',
...
'        CASE WHEN :P131_TIPO_INDICADOR = 5 THEN',
'            TO_CHAR(',
'                CASE WHEN (SELECT NVL((SUM(FEBRERO)),0) FROM SUMA_EGRESOS) = 0 THEN',
'                    0',
'                ELSE',
'                    ((SELECT NVL((SUM(FEBRERO)),0) FROM SUMA_INGRESO) / (SELECT NVL((SUM(FEBRERO)),0) FROM SUMA_EGRESOS))',
'                END',
'            , ''999G999G999G999G990D00'')',
'        ELSE',
'            NULL',
...
'        CASE WHEN :P131_TIPO_INDICADOR = 5 THEN',
'            TO_CHAR(',
'                CASE WHEN (SELECT NVL((SUM(MARZO)),0) FROM SUMA_EGRESOS) = 0 THEN',
'                    0',
'                ELSE',
'                    ((SELECT NVL((SUM(MARZO)),0) FROM SUMA_INGRESO) / (SELECT NVL((SUM(MARZO)),0) FROM SUMA_EGRESOS))',
'                END',
'            , ''999G999G999G999G990D00'')',
'        ELSE',
'            NULL',
...
'        CASE WHEN :P131_TIPO_INDICADOR = 5 THEN',
'            TO_CHAR(',
'                CASE WHEN (SELECT NVL((SUM(ABRIL)),0) FROM SUMA_EGRESOS) = 0 THEN',
'                    0',
'                ELSE',
'                    ((SELECT NVL((SUM(ABRIL)),0) FROM SUMA_INGRESO) / (SELECT NVL((SUM(ABRIL)),0) FROM SUMA_EGRESOS))',
'                END',
'            , ''999G999G999G999G990D00'')',
'        ELSE',
'            NULL',
...
'        CASE WHEN :P131_TIPO_INDICADOR = 5 THEN',
'            TO_CHAR(',
'                CASE WHEN (SELECT NVL((SUM(MAYO)),0) FROM SUMA_EGRESOS) = 0 THEN',
'                    0',
'                ELSE',
'                    ((SELECT NVL((SUM(MAYO)),0) FROM SUMA_INGRESO) / (SELECT NVL((SUM(MAYO)),0) FROM SUMA_EGRESOS))',
'                END',
'            , ''999G999G999G999G990D00'')',
'        ELSE',
'            NULL',
...
'        CASE WHEN :P131_TIPO_INDICADOR = 5 THEN',
'            TO_CHAR(',
'                CASE WHEN (SELECT NVL((SUM(JUNIO)),0) FROM SUMA_EGRESOS) = 0 THEN',
'                    0',
'                ELSE',
'                    ((SELECT NVL((SUM(JUNIO)),0) FROM SUMA_INGRESO) / (SELECT NVL((SUM(JUNIO)),0) FROM SUMA_EGRESOS))',
'                END',
'            , ''999G999G999G999G990D00'')',
'        ELSE',
'            NULL',
...
'        CASE WHEN :P131_TIPO_INDICADOR = 5 THEN',
'            TO_CHAR(',
'                CASE WHEN (SELECT NVL((SUM(JULIO)),0) FROM SUMA_EGRESOS) = 0 THEN',
'                    0',
'                ELSE',
'                    ((SELECT NVL((SUM(JULIO)),0) FROM SUMA_INGRESO) / (SELECT NVL((SUM(JULIO)),0) FROM SUMA_EGRESOS))',
'                END',
'            , ''999G999G999G999G990D00'')',
'        ELSE',
'            NULL',
...
'        CASE WHEN :P131_TIPO_INDICADOR = 5 THEN',
'            TO_CHAR(',
'                CASE WHEN (SELECT NVL((SUM(AGOSTO)),0) FROM SUMA_EGRESOS) = 0 THEN',
'                    0',
'                ELSE',
'                    ((SELECT NVL((SUM(AGOSTO)),0) FROM SUMA_INGRESO) / (SELECT NVL((SUM(AGOSTO)),0) FROM SUMA_EGRESOS))',
'                END',
'            , ''999G999G999G999G990D00'')',
'        ELSE',
'            NULL',
...
'        CASE WHEN :P131_TIPO_INDICADOR = 5 THEN',
'            TO_CHAR(',
'                CASE WHEN (SELECT NVL((SUM(SEPTIEMBRE)),0) FROM SUMA_EGRESOS) = 0 THEN',
'                    0',
'                ELSE',
'                    ((SELECT NVL((SUM(SEPTIEMBRE)),0) FROM SUMA_INGRESO) / (SELECT NVL((SUM(SEPTIEMBRE)),0) FROM SUMA_EGRESOS))',
'                END',
'            , ''999G999G999G999G990D00'')',
'        ELSE',
'            NULL',
...
'        CASE WHEN :P131_TIPO_INDICADOR = 5 THEN',
'            TO_CHAR(',
'                CASE WHEN (SELECT NVL((SUM(OCTUBRE)),0) FROM SUMA_EGRESOS) = 0 THEN',
'                    0',
'                ELSE',
'                    ((SELECT NVL((SUM(OCTUBRE)),0) FROM SUMA_INGRESO) / (SELECT NVL((SUM(OCTUBRE)),0) FROM SUMA_EGRESOS))',
'                END',
'            , ''999G999G999G999G990D00'')',
'        ELSE',
'            NULL',
...
'        CASE WHEN :P131_TIPO_INDICADOR = 5 THEN',
'            TO_CHAR(',
'                CASE WHEN (SELECT NVL((SUM(NOVIEMBRE)),0) FROM SUMA_EGRESOS) = 0 THEN',
'                    0',
'                ELSE',
'                    ((SELECT NVL((SUM(NOVIEMBRE)),0) FROM SUMA_INGRESO) / (SELECT NVL((SUM(NOVIEMBRE)),0) FROM SUMA_EGRESOS))',
'                END',
'            , ''999G999G999G999G990D00'')',
'        ELSE',
'            NULL',
...
'        CASE WHEN :P131_TIPO_INDICADOR = 5 THEN',
'            TO_CHAR(',
'                CASE WHEN (SELECT NVL((SUM(DICIEMBRE)),0) FROM SUMA_EGRESOS) = 0 THEN',
'                    0',
'                ELSE',
'                    ((SELECT NVL((SUM(DICIEMBRE)),0) FROM SUMA_INGRESO) / (SELECT NVL((SUM(DICIEMBRE)),0) FROM SUMA_EGRESOS))',
'                END',
'            , ''999G999G999G999G990D00'')',
'        ELSE',
'            NULL',
...
'        CASE WHEN :P131_TIPO_INDICADOR = 5 THEN',
'            TO_CHAR(',
'                CASE WHEN (SELECT NVL((SUM(TOTAL)),0) FROM SUMA_EGRESOS) = 0 THEN',
'                    0',
'                ELSE',
'                    ((SELECT NVL((SUM(TOTAL)),0) FROM SUMA_INGRESO) / (SELECT NVL((SUM(TOTAL)),0) FROM SUMA_EGRESOS))',
'                END',
'            , ''999G999G999G999G990D00'')',
'        ELSE',
'            NULL',
...
'FROM DUAL;'))
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P131_TIPO_INDICADOR'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_prn_content_disposition=>'ATTACHMENT'
,p_prn_units=>'INCHES'
,p_prn_paper_size=>'LETTER'
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(2221329511015365264)
,p_max_row_count=>'1000000'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
,p_show_search_bar=>'N'
...
,p_enable_mail_download=>'Y'
,p_owner=>'RODRIGO.GARCIA@AICSACORP.COM'
,p_internal_uid=>2221329511015365264
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1118238063627117745)
,p_db_column_name=>'PADRE'
,p_display_order=>10
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1118238479159117746)
,p_db_column_name=>'CODIGO'
,p_display_order=>20
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1118238841894117747)
,p_db_column_name=>'NOMBRE'
,p_display_order=>30
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1118239261875117748)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1118239668429117748)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1118240023408117749)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1118240477065117750)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1118240852706117750)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1118241275344117751)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1118241695340117752)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1118242061863117752)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1118242445367117753)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1118242896461117754)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1118243248566117754)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1118243601688117755)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1118244092899117756)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1118244498684117757)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1118244882920117757)
,p_db_column_name=>'NIVEL'
,p_display_order=>180
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(2224292505434711966)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2224778138755807154)
,p_plug_name=>'FILTROS'
,p_parent_plug_id=>wwv_flow_imp.id(2221329440261365263)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1118245817217117759)
,p_name=>'P131_FILTROS_NIVEL'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(2224778138755807154)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1118246251389117765)
,p_name=>'P131_FECHA_INICIO'
,p_item_sequence=>10
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1118246607860117766)
,p_name=>'P131_FECHA_FIN'
,p_item_sequence=>20
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1118247073729117766)
,p_name=>'P131_EMPRESA'
,p_item_sequence=>30
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1118247462341117766)
,p_name=>'P131_UNIDAD'
,p_item_sequence=>40
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1118247819787117767)
,p_name=>'P131_TIPO_INDICADOR'
,p_item_sequence=>50
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1145625547854797204)
,p_name=>'P131_NOMBRE_INDICADOR'
,p_item_sequence=>60
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1118250379645117775)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1145625640412797205)
,p_event_id=>wwv_flow_imp.id(1118250379645117775)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P131_NOMBRE_INDICADOR'
,p_attribute_01=>'FUNCTION_BODY'
,p_attribute_06=>wwv_flow_string.join(wwv_flow_t_varchar2(
'DECLARE',
'    CURSOR C_DATO IS',
'        SELECT INDICADOR FROM SAF.CON_INDICADORES WHERE ID = :P131_TIPO_INDICADOR;',
'    ',
...
'END;'))
,p_attribute_07=>'P131_TIPO_INDICADOR'
,p_attribute_08=>'Y'
,p_attribute_09=>'N'
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1118250885845117776)
,p_event_id=>wwv_flow_imp.id(1118250379645117775)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attribute_01=>'apex.util.getTopApex().jQuery(".INDICADOR_DETALLES .ui-dialog-title").text(apex.item(''P131_NOMBRE_INDICADOR'').getValue());'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1118249402745117774)
,p_name=>'AFTER_REFRESH_BALANCE_GENERAL_TABLE'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(2221326402253365233)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterrefresh'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1118249980861117775)
,p_event_id=>wwv_flow_imp.id(1118249402745117774)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1118251213091117776)
,p_name=>'AFTER_REFRESH_BALANCE_FILTRADO'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(2221329440261365263)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterrefresh'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1118251756506117777)
,p_event_id=>wwv_flow_imp.id(1118251213091117776)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1118253098302117778)
,p_name=>'FILTRO_NIVELES'
,p_event_sequence=>30
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P131_FILTROS_NIVEL'
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'change'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1118253592168117778)
,p_event_id=>wwv_flow_imp.id(1118253098302117778)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1118253926721117779)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1118254429660117779)
,p_event_id=>wwv_flow_imp.id(1118253926721117779)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'var dato = apex.item( "P131_FILTROS_NIVEL" ).getValue();',
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1118255472194117781)
,p_event_id=>wwv_flow_imp.id(1118253926721117779)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1118252183155117777)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1118252633202117778)
,p_event_id=>wwv_flow_imp.id(1118252183155117777)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P131_FILTROS_NIVEL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1118248293719117768)
...
begin
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1118248697084117768)
...
'    	WHERE ID_INDICADOR = :P131_TIPO_INDICADOR',
'    	AND A.FUNCION = ''+'';',
'    ',
'    CURSOR C_EGRESO IS',
'        SELECT',
...
'                        (',
'                            SELECT ',
'                                REPLACE(REPLACE(REGEXP_SUBSTR(:P131_EMPRESA, ''[^\|]+'', 1, level), ''['',''''), '']'', '''') AS CODIGO_EMPRESA',
'                            FROM ',
'                                dual CONNECT BY REGEXP_SUBSTR(:P131_EMPRESA, ''[^\|]+'', 1, level) IS NOT NULL',
'                        )',
...
'            	(GET_CARDINALIDAD_CUENTA_CONTABLE(A.COD_CTA,A.VALOR,A.DB_HB,2020) ) AS SALDO,',
'              --  GET_CARDINALIDAD_CUENTA_CONTABLE(A.COD_CTA,A.VALOR,A.DB_HB,2020)  AS SALDO,',
'            	A.MES',
...
'                AND B.FUNCION = ''+''',
'            WHERE B.ID_INDICADOR = :P131_TIPO_INDICADOR ',
'            AND A.CODIGO_EMPRESA IN ',
'            (',
'                SELECT CODIGO_EMPRESA FROM TEMP_EMPRESAS WHERE ESTADO IS NOT NULL',
'            )AND TO_DATE(A.FPOL) BETWEEN TO_DATE(:P131_FECHA_INICIO,''DD/mm/yyyy'') AND TO_DATE(:P131_FECHA_FIN,''DD/mm/yyyy'')',
'          --  AND TRUNC(FECHA_POLIZA) BETWEEN TRUNC(TO_DATE(:P131_FECHA_INICIO, ''DD/MM/YYYY'')) AND TRUNC(TO_DATE(:P131_FECHA_FIN, ''DD/MM/YYYY''))',
'            AND B.FUNCION = ''+''',
'        ),',
'        SALDO_EGRESOS AS (',
'            SELECT ',
...
'        END LOOP;',
'',
'        CASE :P131_TIPO_INDICADOR',
'            WHEN 5 THEN',
'                apex_collection.add_member(',
'                    p_collection_name => ''COLLECTION_DETALLE'',',
'                    p_c002 => ''EGRESO'',',
'                    p_c003 => ''Activos Totales'',',
'                    p_c004 => ''EGRESO''',
'                );',
'            ELSE',
'                apex_collection.add_member(',
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1118249086736117772)
